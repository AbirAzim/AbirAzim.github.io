...
export class RainLayer {
    ...
    initDrops() {
        ...
        const heavyN = Math.min(mobile ? 130 : 280, Math.max(65, Math.floor(area / 12000)));
        const drizzleN = Math.min(mobile ? 150 : 340, Math.max(75, Math.floor(area / 7500)));
    ...
    animate = () => {
        ...
        const pal = light
            ? {
                  heavy: {
                      head: 'rgba(55, 85, 118, 0.72)',
                      mid: 'rgba(90, 118, 148, 0.38)',
                      tail: 'rgba(148, 163, 184, 0)',
                  },
                  drizzle: {
                      head: 'rgba(75, 105, 138, 0.55)',
                      mid: 'rgba(110, 138, 168, 0.22)',
                      tail: 'rgba(160, 180, 200, 0)',
                  },
              }
            : {
                  heavy: {
                      head: 'rgba(215, 232, 248, 0.78)',
                      mid: 'rgba(140, 178, 210, 0.42)',
                      tail: 'rgba(95, 140, 175, 0)',
                  },
                  drizzle: {
                      head: 'rgba(185, 210, 232, 0.58)',
                      mid: 'rgba(125, 165, 198, 0.28)',
